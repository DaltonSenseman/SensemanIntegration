...
public class RngSystem {
   ...
   */
  /**
   * Sets the roll for all random RNG based things.
   * @param numOfDice the number of dice to be used in the roll.
   * @param numOfSides the number of sides on each of the dice to be rolled. 
   */
